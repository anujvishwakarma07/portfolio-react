        ...
        >
          {reviewList.map((item) => (
            <SwiperSlide key={item._id}>
              <div className="testimonial-items-v1 cmn-shadow round8" style={{
                display: 'flex',
                ...
                <div className="d-flex flex-wrap align-items-center justify-content-between gap-2 mt-3" style={{ borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '12px' }}>
                  <div className="cont">
